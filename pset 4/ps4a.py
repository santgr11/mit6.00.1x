...
def updateHand(hand, word):
    ...
    for letter in word:
        update[letter] = update.get(letter, 0) - 1
...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        for letter in word:
            if (checking.get(letter, 0)) < 1:
                return False
            else:
                checking[letter] = checking.get(letter, 0) - 1
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    score = 0
    cHand = hand.copy()
    while calculateHandlen(cHand) > 0:
        ...
        if word == ".":
            ...
            if not isValidWord(word, cHand, wordList):
                ...
                hand = updateHand(cHand, word)
                print("")
                
    if calculateHandlen(cHand) < 1:
        print("")
